...
def Tadasana():
    ...
    while True:
        ...
        try:
            ...
            if 162 < l_knee_inclination < 185 and 140 < l_ankle_inclination < 155:
            ...
            # cv2.putText(image, angle_text_str1, (10, 120), font, 0.6, light_green, 2)
                ...
                cv2.line(image, (l_hip_x, l_hip_y), (r_hip_x, r_hip_y), green, 1)
                # Line For Hip To Knee :-
                cv2.line(image, (l_hip_x, l_hip_y), (l_knee_x, l_knee_y), green, 1)
                cv2.line(image, (r_hip_x, r_hip_y), (r_knee_x, r_knee_y), green, 1)

                # Line For Knee To Ankle :-
                cv2.line(image, (l_knee_x, l_knee_y), (l_ankle_x, l_ankle_y), green, 1)
                cv2.line(image, (r_knee_x, r_knee_y), (r_ankle_x, r_ankle_y), green, 1)

                # Line For Ankle To Heel :- 
                cv2.line(image, (l_ankle_x, l_ankle_y), (l_heel_x, l_heel_y), green, 1)
                cv2.line(image, (r_ankle_x, r_ankle_y), (r_heel_x, r_heel_y), green, 1)

            else:
            #  cv2.putText(image, angle_text_str, (10, 90), font, 0.6, red, 2)
            # cv2.putText(image, angle_text_str1, (10, 120), font, 0.6, red, 2)
                #Line For Left Hip TO Right Hip
                cv2.line(image, (l_hip_x, l_hip_y), (r_hip_x, r_hip_y), red, 1)
                # Line For Hip To Knee :-
                cv2.line(image, (l_hip_x, l_hip_y), (l_knee_x, l_knee_y), red, 1)
                cv2.line(image, (r_hip_x, r_hip_y), (r_knee_x, r_knee_y), red, 1)

                # Line For Knee To Ankle :-
                cv2.line(image, (l_knee_x, l_knee_y), (l_ankle_x, l_ankle_y), red, 1)
                cv2.line(image, (r_knee_x, r_knee_y), (r_ankle_x, r_ankle_y), red, 1)

                # Line For Ankle To Heel :- 
                cv2.line(image, (l_ankle_x, l_ankle_y), (l_heel_x, l_heel_y), red, 1)
                cv2.line(image, (r_ankle_x, r_ankle_y), (r_heel_x, r_heel_y), red, 1)
            ...
            if 160 < l_wrist_inclination < 180 and 0 < l_elbow_inclination < 12:
                # cv2.putText(image, angle_text_string, (10, 30), font, 0.5, light_green, 1)
                # cv2.putText(image, angle_text_string1, (10, 60), font, 0.5, light_green, 1)
                
                cv2.line(image, (l_elbow_x, l_elbow_y), (l_wrist_x, l_wrist_y), green, 1)
                cv2.line(image, (r_elbow_x, r_elbow_y), (r_wrist_x, r_wrist_y), green, 1)
                cv2.line(image, (l_shldr_x, l_shldr_y), (l_elbow_x, l_elbow_y), green, 1)
                cv2.line(image, (r_shldr_x, r_shldr_y), (r_elbow_x, r_elbow_y), green, 1)
            
            else:
                # cv2.putText(image, angle_text_string, (10, 30), font, 0.5, red, 1)
                # cv2.putText(image, angle_text_string1, (10, 60), font, 0.5, red, 1)
                
                cv2.line(image, (l_elbow_x, l_elbow_y), (l_wrist_x, l_wrist_y), red, 1)
                cv2.line(image, (r_elbow_x, r_elbow_y), (r_wrist_x, r_wrist_y), red, 1)
                cv2.line(image, (l_shldr_x, l_shldr_y), (l_elbow_x, l_elbow_y), red, 1)
                cv2.line(image, (r_shldr_x, r_shldr_y), (r_elbow_x, r_elbow_y), red, 1)
            ...
            if 82 < shoulder_inclination and shoulder_inclination < 96:
                
            
            # cv2.putText(image, angle_text_string1, (10,150), font, 0.6, green, 2)
                
            
                cv2.line(image, (l_shldr_x, l_shldr_y), (r_shldr_x, r_shldr_y), green, 1)
            ...
            # cv2.putText(image, angle_text_string1, (10, 150), font, 0.6, red, 2)
                ...
                cv2.line(image, (l_shldr_x, l_shldr_y), (r_shldr_x, r_shldr_y), red, 1)                
            ...
            if 82 < hip_inclination and hip_inclination < 96:
            ...
            if 165 < l_StoH_inclination and l_StoH_inclination < 175 and 165 < r_StoH_inclination and r_StoH_inclination < 175:
                
                # cv2.putText(image, angle_text_string, (10, 210), font, 0.6, green, 2)
                # cv2.putText(image, angle_text_string1, (10, 240), font, 0.6, green, 2)
                
                cv2.line(image, (l_shldr_x, l_shldr_y), (l_hip_x, l_hip_y), green, 1)
                cv2.line(image, (r_shldr_x, r_shldr_y), (r_hip_x, r_hip_y), green, 1)
            
            else:
                # cv2.putText(image, angle_text_string, (10, 210), font, 0.6,red, 2)
                # cv2.putText(image, angle_text_string1, (10, 240), font, 0.6, red, 2)
                
                cv2.line(image, (l_shldr_x, l_shldr_x), (l_hip_x, l_hip_x), red, 1)
                cv2.line(image, (r_shldr_x, r_shldr_y), (r_hip_x, r_hip_y), red, 1)             
